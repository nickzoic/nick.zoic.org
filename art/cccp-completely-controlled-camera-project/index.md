...
a fixed target at 3.0 meters:

front ring | rear ring | zoom
---|---|---
0 | 28.75 | tele
5 | 32.5 |
10 | 36.25 |
...
The relationship between the two is not linear!  By picking an arbitrary
...
This is pretty arbitrary, of course.
